...
<!-- Nombrar la transición: con esta sesión termina el tramo de "cómo trabajo bien con esta herramienta". Las próximas dos desarman la máquina: la Sesión 5 abre el harness por adentro y la Sesión 6 cambia el modelo que tiene abajo. TAREA: mantener los docs vivos durante la semana; cada decisión nueva va al doc de su feature; anotar cuándo los docs sirvieron y cuándo quedaron desactualizados respecto del código. -->
