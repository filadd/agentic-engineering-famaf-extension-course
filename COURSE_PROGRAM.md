...
- [Pi + llama.cpp](https://pi.dev/docs/latest/llama-cpp) — how Agus serves his endpoint, and the take-home appendix. `/login llama.cpp` → `/llama` → `/model`.
